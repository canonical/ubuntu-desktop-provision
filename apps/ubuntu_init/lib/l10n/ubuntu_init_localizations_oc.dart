...
class UbuntuInitLocalizationsOc extends UbuntuInitLocalizations {
  ...
  String get welcomeStartSubtitle =>
      'Encoratja a una experiéncia de configuracion mai neta.';
  ...
  String get welcomeStoreSubtitle =>
      'Jamai es pas estat tan simple de trobar vòstre logicial preferit.';
  ...
  String get welcomeSecuritySubtitle =>
      'Opcions novèlas de chiframent material o ZFS.';
  ...
  String get telemetryCollectError =>
      'Fracàs de la collècta de donadas de telemetria';
  ...
  String get privacyLocationSubtitle =>
      'Permet que las aplicacions ajan accès a vòstre posicion geografica.\nO podètz cambiar quand volètz als Paramètres del sistèma.';
  ...
  String get ubuntuProSubscriptionDescription =>
      'Soscrivètz a l’abonament amb la melhora seguretat dels logicials liures';
  ...
  String get ubuntuProTokenAttachErrorVariant =>
      'Get on invalid, tornatz ensajar';
  ...
  String get ubuntuProOnBoardingSkipForNowDescription =>
      'Podètz totjorn activar Ubuntu Pro mai tard dins l’aplicacion Logicials e mesas a jorn.';
  ...
  String get ubuntuProOnBoardingEnableUbuntuProDescription =>
      'Ligatz aquesta maquina a un abonament Ubuntu Pro per de mesas a jorn de seguretat sus un grand nombre de paquets, fins a 2032.';

  @override
  String get ubuntuProSucessAttachHeader =>
      'Ubuntu Pro es ara activat sus aquesta maquina';
