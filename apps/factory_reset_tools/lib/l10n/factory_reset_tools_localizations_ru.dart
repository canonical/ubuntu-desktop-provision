...
class FactoryResetToolsLocalizationsRu extends FactoryResetToolsLocalizations {
  ...
  String get createUsbBody =>
      'Создайте USB-носитель для сброса, чтобы восстановить систему, а также настроить установку Ubuntu.';

  @override
  String get createUsbListExplanation =>
      'Выберите флэш-накопитель USB. На накопителе должно быть **не менее 16 Гб места.**';

  @override
  String get createUsbWarning =>
      'Флеш-накопитель будет переформатирован, а все данные на нём будут потеряны.';
  ...
  String get noMediaDetectedSubtitle =>
      'Для создания носителя для сброса необходим USB-накопитель.';
  ...
  String get resetMediaReadyBody =>
      'Когда захотите им воспользоваться, вставьте этот USB-накопитель в компьютер, который хотите сбросить, и перезагрузите его.';
