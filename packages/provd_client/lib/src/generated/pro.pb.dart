...
class ProMagicAttachResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ProMagicAttachResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'pro'), createEmptyInstance: create)
    ..e<MagicAttachResponseType>(1, _omitFieldNames ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: MagicAttachResponseType.USER_CODE, valueOf: MagicAttachResponseType.valueOf, enumValues: MagicAttachResponseType.values)
  ...
  @$pb.TagNumber(1)
  MagicAttachResponseType get type => $_getN(0);
  @$pb.TagNumber(1)
  set type(MagicAttachResponseType v) { setField(1, v); }
  @$pb.TagNumber(1)
