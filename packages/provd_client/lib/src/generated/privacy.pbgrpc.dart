...
class PrivacyServiceClient extends $grpc.Client {
  static final _$getLocationServices = $grpc.ClientMethod<$0.Empty, $1.BoolValue>(
  ...
  $grpc.ResponseFuture<$1.BoolValue> getLocationServices($0.Empty request, {$grpc.CallOptions? options}) {
