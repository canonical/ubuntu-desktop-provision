...
Future<void> runInstallerApp(
  ...
  final options = parseCommandLine(args, onPopulateOptions: (parser) {
    ...
    parser.addOption('live-system',
        help:
            'Whether the installer is running in a "live" system with a desktop and all, or not.',
        defaultsTo: '1');
    parser.addOption('disable-install-along',
        help:
            'It is not possible to install Core Desktop along other operating systems, so in that case, that option must be disabled.',
        defaultsTo: '0');
  })!;
