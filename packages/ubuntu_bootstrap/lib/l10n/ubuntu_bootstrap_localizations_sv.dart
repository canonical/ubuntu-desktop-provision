...
class UbuntuBootstrapLocalizationsSv extends UbuntuBootstrapLocalizations {
  ...
  @override
  String get autoinstallAutomatedDescription => 'För avancerade användare som har en autoinstall.yaml för konsekventa och repeterbara systemkonfigurationer.';
  ...
  String installationTypeTPMInfo(String DISTRO, String url) {
    return 'Detta är en experimentell funktion. Det kanske inte fungerar med din hårdvara eller med framtida $DISTRO släpp. <a href=\"$url\">Läs om TPM kryptering</a> innan du väljer detta alternativ.';
  }
