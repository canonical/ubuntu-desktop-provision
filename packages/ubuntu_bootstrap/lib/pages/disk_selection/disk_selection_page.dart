...
import 'package:ubuntu_bootstrap/pages/disk_selection/disk_selection_model.dart';
...
class DiskSelectionPage extends ConsumerWidget with ProvisioningPage {
  DiskSelectionPage({super.key});

  final ScrollController _scrollController = ScrollController();

  @override
  Future<bool> load(BuildContext context, WidgetRef ref) {
    return ref.read(diskSelectionModelProvider).init().then((_) => true);
  }

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final model = ref.watch(diskSelectionModelProvider);
...
class _DiskListTile extends ConsumerWidget {
  const _DiskListTile(this.source);

  final DiskSelection source;
