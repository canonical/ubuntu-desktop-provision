...
class MockNetworkManagerSettingsConnection extends _i1.Mock
  ...
  @override
  _i3.Future<Map<String, Map<String, _i5.DBusValue>>> getSettings() =>
      (super.noSuchMethod(
        Invocation.method(
          #getSettings,
          [],
        ),
        returnValue: _i3.Future<Map<String, Map<String, _i5.DBusValue>>>.value(
            <String, Map<String, _i5.DBusValue>>{}),
      ) as _i3.Future<Map<String, Map<String, _i5.DBusValue>>>);

  @override
  _i3.Future<Map<String, Map<String, _i5.DBusValue>>> getSecrets(
