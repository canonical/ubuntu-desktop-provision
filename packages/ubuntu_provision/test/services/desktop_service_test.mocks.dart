...
class MockGnomeSessionManager extends _i1.Mock
  ...
  @override
  _i5.Future<bool> canShutdown() => (super.noSuchMethod(
        Invocation.method(
          #canShutdown,
          [],
        ),
  ...
  @override
  _i5.Future<bool> isSessionRunning() => (super.noSuchMethod(
        Invocation.method(
          #isSessionRunning,
          [],
        ),
  ...
  @override
  _i5.Future<void> uninhibit(int? cookie) => (super.noSuchMethod(
        Invocation.method(
          #uninhibit,
          [cookie],
        ),
  ...
  @override
  _i5.Future<bool> isInhibited(Set<_i3.GnomeInhibitionFlag>? flags) =>
      (super.noSuchMethod(
        Invocation.method(
          #isInhibited,
          [flags],
