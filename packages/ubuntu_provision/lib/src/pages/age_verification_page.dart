...
import 'package:ubuntu_init/services/provd_age_verification_service.dart';
import 'package:ubuntu_provision/ubuntu_provision.dart';
import 'package:ubuntu_wizard/ubuntu_wizard.dart';

final ageVerificationServiceProvider = Provider(
  (_) => ProvdAgeVerificationService(),
);
        ...
        WizardAction(
          ...
          onActivated: () async {
            if (_birthYear != null) {
              ...
              final identity = ref.read(identityModelProvider);
              await service.setAge(identity.username, _birthYear!);
