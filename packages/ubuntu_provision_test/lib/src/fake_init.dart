...
class FakeProvdUserClient implements ProvdUserClient {
  @override
  Future<User> getUser(String userId) async => User();
  ...
  @override
  Future<bool> validateUsername(String username) async => true;
}
