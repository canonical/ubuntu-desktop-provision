...
func (s *Service) EnableDesktopZoom(ctx context.Context, req *emptypb.Empty) (*emptypb.Empty, error) {
	return setBooleanSettings(ctx, s.applicationSettings, "screen-magnifier-enabled", true, "failed to enable desktop zoom: %v")
}
...
func (s *Service) DisableDesktopZoom(ctx context.Context, req *emptypb.Empty) (*emptypb.Empty, error) {
	return setBooleanSettings(ctx, s.applicationSettings, "screen-magnifier-enabled", false, "failed to disable desktop zoom: %v")
}
