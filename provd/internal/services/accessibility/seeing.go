...
func (s *Service) EnableHighContrast(ctx context.Context, req *emptypb.Empty) (*emptypb.Empty, error) {
	return setBooleanSettings(ctx, s.a11ySettings, "high-contrast", true, "failed to enable high contrast: %v")
}
...
func (s *Service) DisableHighContrast(ctx context.Context, req *emptypb.Empty) (*emptypb.Empty, error) {
	return setBooleanSettings(ctx, s.a11ySettings, "high-contrast", false, "failed to disable high contrast: %v")
}
...
func (s *Service) EnableReducedMotion(ctx context.Context, req *emptypb.Empty) (*emptypb.Empty, error) {
	return setBooleanSettings(ctx, s.interfaceSettings, "enable-animations", false, "failed to enable reduced motion: %v")
}
...
func (s *Service) DisableReducedMotion(ctx context.Context, req *emptypb.Empty) (*emptypb.Empty, error) {
	return setBooleanSettings(ctx, s.interfaceSettings, "enable-animations", true, "failed to disable reduced motion: %v")
}
...
func (s *Service) EnableLargeText(ctx context.Context, req *emptypb.Empty) (*emptypb.Empty, error) {
	return setDoubleSettings(ctx, s.interfaceSettings, "text-scaling-factor", textScalingLarge, "failed to enable large text: %v")
}
...
func (s *Service) DisableLargeText(ctx context.Context, req *emptypb.Empty) (*emptypb.Empty, error) {
	return setDoubleSettings(ctx, s.interfaceSettings, "text-scaling-factor", textScalingDefault, "failed to disable large text: %v")
}
...
func (s *Service) EnableScreenReader(ctx context.Context, req *emptypb.Empty) (*emptypb.Empty, error) {
	return setBooleanSettings(ctx, s.applicationSettings, "screen-reader-enabled", true, "failed to enable screen reader: %v")
}
...
func (s *Service) DisableScreenReader(ctx context.Context, req *emptypb.Empty) (*emptypb.Empty, error) {
	return setBooleanSettings(ctx, s.applicationSettings, "screen-reader-enabled", false, "failed to disable screen reader: %v")
}
