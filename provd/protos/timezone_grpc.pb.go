...
func (c *timezoneServiceClient) SetTimezone(ctx context.Context, in *SetTimezoneRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, TimezoneService_SetTimezone_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *timezoneServiceClient) GetTimezone(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*GetTimezoneResponse, error) {
	...
	err := c.cc.Invoke(ctx, TimezoneService_GetTimezone_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func RegisterTimezoneServiceServer(s grpc.ServiceRegistrar, srv TimezoneServiceServer) {
	// If the following call pancis, it indicates UnimplementedTimezoneServiceServer was
