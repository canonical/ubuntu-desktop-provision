...
func (c *timezoneServiceClient) SetTimezone(ctx context.Context, in *SetTimezoneRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, "/timezone.TimezoneService/SetTimezone", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *timezoneServiceClient) GetTimezone(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*GetTimezoneResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/timezone.TimezoneService/GetTimezone", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _TimezoneService_SetTimezone_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/timezone.TimezoneService/SetTimezone",
	}
...
func _TimezoneService_GetTimezone_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/timezone.TimezoneService/GetTimezone",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
