...
type User struct {
	...
	BirthDate     string                 `protobuf:"bytes,6,opt,name=birth_date,json=birthDate,proto3" json:"birth_date,omitempty"` // Required. ISO 8601 calendar date (YYYY-MM-DD).
...
const file_protos_user_proto_rawDesc = "" +
	"\n" +
	"\x11protos/user.proto\x12\x04user\x1a\x1bgoogle/protobuf/empty.proto\"\xb5\x01\n" +
	"\x04User\x12\x1b\n" +
	...
	"\n" +
	"auto_login\x18\x05 \x01(\bR\tautoLogin\x12\x1d\n" +
	"\n" +
	"birth_date\x18\x06 \x01(\tR\tbirthDate\"N\n" +
